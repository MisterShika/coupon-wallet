    ...
    <div class="flex">
        ...
        <div class="w-5/6 lg:w-10/12 float-left p-6">
            <div v-if="this.$store.state.loggedIn.loggedStatus && getAccount">
                <!-- Bounce transition for individual coupons -->
        ...
        <aside class="w-4/12 lg:w-2/12 p-2 float-right text-center bg-yellow-100 min-h-screen">
            <!-- Logo and Title / <client-only> necessary because of strange "hydration" errors -->
            <div>
            ...
            <!-- Sidebar propagates differently depending on logged-in status -->
