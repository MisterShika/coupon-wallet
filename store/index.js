export const state = () => ({
    ...
    accounts: [
        {userID: 1, userName: "user1", password: "12345", userType: "user", following: [6, 7, 8], followedBy: [], couponsOffered: [], couponsUsed: []},
        {userID: 2, userName: "user2", password: "12345", userType: "user", following: [7, 8, 9], followedBy: [], couponsOffered: [], couponsUsed: []},
        {userID: 3, userName: "user3", password: "12345", userType: "user", following: [9, 10, 6], followedBy: [], couponsOffered: [], couponsUsed: []},
        {userID: 4, userName: "user4", password: "12345", userType: "user", following: [8, 10, 7], followedBy: [], couponsOffered: [], couponsUsed: []},
        {userID: 5, userName: "user5", password: "12345", userType: "user", following: [6, 9, 10], followedBy: [], couponsOffered: [], couponsUsed: []},

        {userID: 6, userName: "user6", password: "12345", userType: "vendor", following: [], followedBy: [1, 3, 5], couponsOffered: [1, 2, 3], couponsUsed: []},
        {userID: 7, userName: "user7", password: "12345", userType: "vendor", following: [], followedBy: [1, 2, 4], couponsOffered: [4, 5, 6], couponsUsed: []},
        {userID: 8, userName: "user8", password: "12345", userType: "vendor", following: [], followedBy: [1, 2, 4], couponsOffered: [7, 8, 9], couponsUsed: []},
        {userID: 9, userName: "user9", password: "12345", userType: "vendor", following: [], followedBy: [2, 3, 5], couponsOffered: [10, 11, 12], couponsUsed: []},
        {userID: 10, userName: "user10", password: "12345", userType: "vendor", following: [], followedBy: [3, 4, 5], couponsOffered: [13, 14, 15], couponsUsed: []},
    ],
