export const state = () => ({
    ...
    accounts: [
        {userID: 1, userName: "user1", password: "12345", userType: "user", following: [6, 7, 8, 11, 12, 13], followedBy: [], couponsOwned: [1, 4, 7, 16, 19, 22], couponsOffered: [], couponsUsed: []},
        {userID: 2, userName: "user2", password: "12345", userType: "user", following: [7, 8, 9, 12, 13, 14], followedBy: [], couponsOwned: [4, 7, 10, 19, 22, 25], couponsOffered: [], couponsUsed: []},
        {userID: 3, userName: "user3", password: "12345", userType: "user", following: [9, 10, 6, 11, 14, 15], followedBy: [], couponsOwned: [10, 13, 1, 16, 25, 28], couponsOffered: [], couponsUsed: []},
        {userID: 4, userName: "user4", password: "12345", userType: "user", following: [8, 10, 7, 12, 13, 15], followedBy: [], couponsOwned: [7, 13, 4, 19, 22, 28], couponsOffered: [], couponsUsed: []},
        {userID: 5, userName: "user5", password: "12345", userType: "user", following: [6, 9, 10, 11, 14, 15], followedBy: [], couponsOwned: [1, 10, 13, 16, 25, 28], couponsOffered: [], couponsUsed: []},
        ...
        {userID: 11, userName: "user11", password: "12345", userType: "vendor", following: [], followedBy: [1, 3, 5], couponsOwned: [], couponsOffered: [16, 17, 18], couponsUsed: []},
        {userID: 12, userName: "user12", password: "12345", userType: "vendor", following: [], followedBy: [1, 2, 4], couponsOwned: [], couponsOffered: [19, 20, 21], couponsUsed: []},
        {userID: 13, userName: "user13", password: "12345", userType: "vendor", following: [], followedBy: [1, 2, 4], couponsOwned: [], couponsOffered: [22, 23, 24], couponsUsed: []},
        {userID: 14, userName: "user14", password: "12345", userType: "vendor", following: [], followedBy: [2, 3, 5], couponsOwned: [], couponsOffered: [25, 26, 27], couponsUsed: []},
        {userID: 15, userName: "user15", password: "12345", userType: "vendor", following: [], followedBy: [3, 4, 5], couponsOwned: [], couponsOffered: [28, 29, 30], couponsUsed: []},
    ],
